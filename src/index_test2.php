...
.footer .connect_sns,
.footer .bi{display:none}
.footer .copyright{padding-bottom:14px;text-align:center}
.wrap.intro .intro_footer_cover .footer{width:auto;min-width:320px}
.wrap.intro .intro_content_cover #slider_container_main{left:-310px}
}
</style>
</head>
<body>
<div class="wrap intro">
	<div class="intro_header_cover">
		<h1 class="bi" style="min-width:320px"><a href="main.php"><i>Celebrity X Cruises</i></a></h1>
	</div>
	<div class="intro_content_cover" style="min-width:320px">		
